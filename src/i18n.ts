...
const translations = {
  de: {
    ...
    storage_denied_body: 'Dein Browser hat den dauerhaften Speicher abgelehnt. Deine Daten werden möglicherweise beim Schließen des Browsers gelöscht. Du kannst trotzdem fortfahren, aber es wird empfohlen, regelmäßig zu exportieren.',
  ...
  en: {
    ...
    storage_denied_body: 'Your browser denied persistent storage. Your data may be cleared when the browser is closed. You can still continue, but it\'s recommended to export your data regularly.',
